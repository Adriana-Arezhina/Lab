...
3. Выполнила несколько операций в mc, используя управляющие клавиши
   ...
   ![переместила файл](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/3.JPG)
   Посмотрела вид дерева (см рисунок ниже [вид дерева](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/7.JPG))

![вид дерева](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/7.JPG)
   Посмотрела права доступа (см. рисунок ниже [права доступа](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/4.JPG))

![права доступа](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/4.JPG) 

4. Выполнила основные команды меню левой (или правой) панели. Степень подробности вывода информации о файлах одинаковая. (см рисунок ниже [получила информацию о файле](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/6.JPG))
![получила информацию о файле](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/6.JPG) 
5. Используя возможности подменю Файл:
просмотрела содержимого файла (см. рисунок ниже [содержимого файла](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/5.JPG) )  
![содержимого файла](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/5.JPG)

Отредактировала содержимого текстового файла (без сохранения результатов редактирования); (см рисунок ниже [содержимого текстового файла](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/10.JPG))  
...
Скопировала файл в созданный каталог (см. рисунок ниже [скопировала файл](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/12.JPG))  
![скопировала файл](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/12.JPG)

6. С помощью соответствующих средств подменю Команда:
   осуществила поиск в файловой системе файла с заданными условиями (например файла с расширением .c содержащего строку main); (см. рисунок ниже [поиск в файловой системе](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/13.JPG)
   ![поиск в файловой системе](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/13.JPG)
   Перешла в домашний каталог (см. рисунок ниже [домашний каталог](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/14.JPG))  
   ![домашний каталог](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/14.JPG)

   Анализировала файл меню и файл расширений (см. рисунок ниже [анализ](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/15.JPG))  
...
1. Открыла файл text.txt с помощью mc.
...
3. Удалила строку текста.
   Выделила фрагмент текста и скопировала его на новую строку. (см. рисунок ниже [скопировала текст на новую строку.](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/21.JPG))  
...
5. Используя меню редактора, включила подсветку синтаксиса. (см. рисунок ниже [подсветка синтаксиса](https://github.com/Adriana-Arezhina/Lab/blob/main/Lab08/pict/27.JPG) )  
