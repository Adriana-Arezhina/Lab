...
1. В домашнем каталоге создала подкаталог *~/work/os/lab_prog*. (см. рисунок ниже [подкаталог](1))

![подкаталог]()

2. Создала в нём файлы: *calculate.h*, *calculate.c*, *main.c*. (см. рисунки ниже [создала файлы](2), [calculate.c](3), [calculate.h](4), [main.c](5))
...
5. Создала *Makefile*. (см. рисунок ниже [makefile](7))
...
*gdb ./calcul*
(см. рисунок ниже [6.1](8))

![6.1]()

- Для запуска программы внутри отладчика введите команду *run*:
*run*
(см. рисунок ниже [6.2](9))
...
*info breakpoints
delete 1*
(см. рисунок ниже [6.5](12))

![6.5]()

7. Не смогла установить утилиту *splint*. (см. рисунок ниже [splint](error))
